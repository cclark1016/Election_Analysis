...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes_dict:
        ...
        county_results = (
            f"{county_name}: {county_vote_percentage:.2f}% ({total_county_votes:,})\n")
        print(county_results) 
         # 6e: Save the county votes to a text file.
        txt_file.write(county_results)
         # 6f: Write a decision statement to determine the winning county and get its vote count.
        if total_county_votes > highest_county_votes and county_vote_percentage > highest_county_percentage:
            highest_county_turnout = county_name
            highest_county_votes = total_county_votes
